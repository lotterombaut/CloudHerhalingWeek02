    ...
    public static class BezoekersService
    {
            ...
            ILogger log)
        {
            List<string> days = new List<string>();
             // we openen een connectie via using statement
             // using zorgt ervoor dat de connectie niet blijft openstaan.

             //                 kies een naam                                         zelfde naam als in local settings
